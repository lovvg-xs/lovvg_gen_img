...
export const generateImage = async (prompt: string, style: ImageStyle, aspectRatio: AspectRatio, apiKey: string): Promise<string> => {
  ...
  const stylePrefix = style === ImageStyle.PIXEL
    ? "Pixel art style, 8-bit, retro, vibrant colors. "
    : "Simple stick figure drawing, clean white background, black lines, minimalist. ";
