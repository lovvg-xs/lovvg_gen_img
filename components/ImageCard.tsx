...
const ImageCard: React.FC<ImageCardProps> = ({ image, index, isSelected, onSelect, onPreview, onDelete }) => {
  ...
  return (
    ...
    >
      ...
      {/* Image Index */}
      <div className="absolute top-2 left-2 w-6 h-6 bg-gray-900 bg-opacity-70 border-2 border-white flex items-center justify-center z-10 text-xs font-bold">
        {index + 1}
      </div>
